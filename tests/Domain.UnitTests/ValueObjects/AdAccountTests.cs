using ContosoUniversityAngular.Domain.Exceptions;
using ContosoUniversityAngular.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace ContosoUniversityAngular.Domain.UnitTests.ValueObjects
{
